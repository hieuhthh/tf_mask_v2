...
# url = "https://drive.google.com/file/d/1Em2UzFHNmygV8POVg7SeAkN6oW6657mT/view?usp=share_link"
...
# url = "https://drive.google.com/file/d/19LBX82s0QrOgPTVHVPKh1QoaffG13qz9/view?usp=share_link"
# output =  f"{des}/Real_faces_align_masked.zip"
# gdown.download(url=url, output=output, quiet=False, fuzzy=True)

# url = "https://drive.google.com/file/d/1215u5KbGYydimbEXCqKsSxzfZ-KLX94z/view?usp=share_link"
# output =  f"{des}/processed_crop.zip"
# gdown.download(url=url, output=output, quiet=False, fuzzy=True)